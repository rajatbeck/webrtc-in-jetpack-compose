...
import com.arx.camera.util.BitmapManager
 ...
 */
open class BitmapFrameCapturer : VideoCapturer, BitmapManager.BitmapReceiver {
  ...
  override fun initialize(
    ...
    synchronized(stateLock) {
      BitmapManager.registerReceiver(this)
  ...
  override fun onDevicePhotoReceived(bitmap: Bitmap, selectedResolution: Resolution) {
     pushBitmap(bitmap, 0)
  }

  override fun onStillPhotoReceived(bitmap: Bitmap, selectedResolution: Resolution) {
